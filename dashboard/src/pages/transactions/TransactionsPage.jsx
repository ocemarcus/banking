    ...
    <section className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filtre por período e tipo de transação</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <select
                ...
                onChange={(event) => onFiltersChange('typeTransaction', event.target.value)}
              >
                <option value="">Todas</option>
                <option value="pixIn">Entrada Pix</option>
                <option value="bankSplitIn">Entrada Boleto</option>
                <option value="transferInternalIn">Transferência interna</option>
                <option value="transferInternalOut">Transferência entre contas</option>
              </select>
            </div>
          </div>
        </CardContent>
